...
class MySubscription extends Component{
	...
	getdata=()=>{
		api.FetchPost('/hyb-stu/stu_user_subscribe/find_user_subscribe_list',{
			...
			if(this.page==1 && !res.data.subscribe_list.length){
				...
				this.setState({ "status" : 'success' ,"list" : res.data.subscribe_list });
			}
		},()=>{
...
MySubscription = connect(mapStateToProps)(MySubscription)
